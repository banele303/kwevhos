                ...
                <div className="container mx-auto px-4">
                    ...
                    <Accordion type="single" collapsible className="w-full max-w-3xl mx-auto text-[20px]">
                        <AccordionItem value="item-1">
                            <AccordionTrigger>What types of industries does Kwevhor serve?</AccordionTrigger>
                            <AccordionContent>
                                Kwevhor serves a wide range of industries, focusing on construction, environmental, and manufacturing businesses. Our diverse expertise allows us to provide tailored consulting services to meet the specific needs of each sector.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-2">
                            <AccordionTrigger>How does Kwevhor support sustainability in its consulting services?</AccordionTrigger>
                            <AccordionContent>
                        ...
                        <AccordionItem value="item-3">
                            <AccordionTrigger>Can Kwevhor assist with both strategic planning and operational implementation?</AccordionTrigger>
                            <AccordionContent>
                        ...
                        <AccordionItem value="item-4">
                            <AccordionTrigger>What sets Kwevhor apart from other consulting firms?</AccordionTrigger>
                            <AccordionContent>
                                Kwevhor stands out due to our industry-specific focus, customized approach, and commitment to sustainability. Our deep knowledge of the construction, environmental, and manufacturing sectors allows us to provide insights and solutions that other firms may not offer. We prioritize personalized service and measurable results.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-5">
                            <AccordionTrigger>Does Kwevhor offer industry-specific consulting services?</AccordionTrigger>
                            <AccordionContent>
